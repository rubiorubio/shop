...
class AddToCartView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        messages.add_message(request, messages.INFO, "The product successfuly added to the cart")
...
class DeleteFromCartView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        cart_product.delete()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "The product successfuly removed from the cart")
        return HttpResponseRedirect('/cart/')
...
class ChangeQTYView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        cart_product.save()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "The quantity successfuly changed")
        return HttpResponseRedirect('/cart/')
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Thank you for your Order! The manager will let you know for the detail in a while')
